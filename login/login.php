...
<?php
    ...
    $sorgu="SELECT * FROM loginpage";
    $sash=$db->prepare($sorgu);
    $sash->execute();  
...
<body>
  <div class="container h-100">
			...
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form method="post">
				 	...
				 	<input type="submit" name="gönder" class="btn login_btn">
				   </div>
					</form>
				</div>
    ...
    if (isset($_POST["gönder"])) {
      foreach ($sash as $user) {
        $email=$user['e-mail'];
        $password=$user['password'];
        $Tmail=$_POST['mail'];
        $Tpassword=$_POST['password'];
       
        if (strcmp($Tmail, $email) == 0  && strcmp($Tpassword, $password) == 0) {
